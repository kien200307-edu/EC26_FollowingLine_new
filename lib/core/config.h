...
#define PID_KP_DEFAULT  0.85f
#define PID_KI_DEFAULT  0.00f
#define PID_KD_DEFAULT  0.12f
...
// =====================================================
// TURN THRESHOLDS & SPEEDS
// =====================================================

#define LIGHT_TURN_THRESHOLD  1000
#define MEDIUM_TURN_THRESHOLD 2000
#define SHARP_TURN_THRESHOLD  2800

#define TURN_SPEED_DEFAULT    120
#define SHARP_TURN_SPEED_DEFAULT 120
...
// CALIBRATION CONFIG
// =====================================================
#define CALIB_DURATION_MS 6000     // Thời gian calib (6 giây)
#define CALIB_LED_INTERVAL 100     // Nháy LED 100ms khi calib
